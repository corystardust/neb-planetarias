...
imagen1 = fits.open('/Users/leslycorina/iraf/archive/hf22-nuevo/abundances/OIII4363cpv4_hbetapv4.fits')  # abrimos la imagen a analizar
datos1 = imagen1[0].data  # guardamos los datos 
header1 = imagen1[0].header  # abrimos el header

imagen2 = fits.open('/Users/leslycorina/iraf/archive/hf22-nuevo/abundances/OIII4959cpv4_hbetapv4.fits')
...
for i in range(nr):
    for j in range(nf):
        Ntemp = O2.getTemDen(int_ratio=datos[i, j], den=1e3, wave1=4363, wave2=4959)
        ratio[i, j] = Ntemp
...
nii = fits.PrimaryHDU()
nii.data = ratio
nii.writeto("hf22temp_4363c_4959c_pv4.fits", overwrite=True)
